...
def on_predict_start(predictor: object, persist: bool = False, frame_rate: int = 30) -> None:
    """
...
def register_tracker(model: object, persist: bool, frame_rate: int) -> None:
    """
    ...
    """
    model.add_callback("on_predict_start", partial(on_predict_start, persist=persist, frame_rate=frame_rate))
